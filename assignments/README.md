This is the code repository for my x86 Assembly Language and Shellcoding on Linux course work. The code used used/referenced in each assignment can be found in its respective directory above.
